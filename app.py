...
def login():
    ...
    if request.method == 'POST':
        ...
        if email in users and users[email]['password'] == password:
            ...
            flash('Invalid email or password. Please sign up if you don\'t have an account.', 'error')
...
def predict():
    ...
    tenure_group = pd.cut([inputQuery19], range(1, 80, 12), right=False, labels=labels)[0]
